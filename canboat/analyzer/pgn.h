...
/*
,
{ "SeaTalk: Node Statistics", 130846, false, 0x08, 0,
  { { "Manufacturer Code", 11, RES_MANUFACTURER, false, "=1851", "Raymarine" }
  , { "Reserved", 2, RES_NOTUSED, false, 0, "" }
  , { "Industry Code", 3, RES_LOOKUP, false, "=4", "Marine Industry" }
  , { "Software Release", BYTES(2), 1, false, 0, "" }
  , { "Development Version", BYTES(1), 1, false, 0, "" }
  , { "Serial Number - Product Code", BYTES(1), 1, false, 0, "" }
  , { "Serial Number - Year", BYTES(1), 1, false, 0, "" }
  , { "Serial Number - Month", BYTES(1), 1, false, 0, "" }
  , { "Serial Number - Device Number", BYTES(2), 1, false, 0, "" }
